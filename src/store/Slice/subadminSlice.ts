...
// // Thunks
// export const createSubAdminUser = createAsyncThunk<User, SubAdminFormData, { rejectValue: string }>(
//   "user/createSubAdminUser",
//   async (data, { rejectWithValue }) => {
//     try {
//       const response = await createSubAdmin(data);
//       return response.user;
//     } catch (error: any) {
//       return rejectWithValue(error.message || "Failed to create subadmin");
//     }
//   }
// );

// export const createNormalUser = createAsyncThunk<User, UserFormData, { rejectValue: string }>(
...
// export const createUserPermission = createAsyncThunk<void, PermissionData, { rejectValue: string }>(
...
//         state.success = false;
//       })
//       .addCase(createSubAdminUser.fulfilled, (state, action: PayloadAction<User>) => {
//         state.loading = false;
//         state.success = true;
//         state.user = action.payload;
//       })
//       .addCase(createSubAdminUser.rejected, (state, action: PayloadAction<string>) => {
//         state.loading = false;
...
//         state.success = false;
//       })
//       .addCase(createNormalUser.fulfilled, (state, action: PayloadAction<User>) => {
//         state.loading = false;
//         state.success = true;
//         state.user = action.payload;
//       })
//       .addCase(createNormalUser.rejected, (state, action: PayloadAction<string>) => {
//         state.loading = false;
//         state.error = action.payload;
//       })
//       .addCase(createUserPermission.rejected, (state, action: PayloadAction<string>) => {
//         state.error = action.payload;
//       });
//   },
// });
