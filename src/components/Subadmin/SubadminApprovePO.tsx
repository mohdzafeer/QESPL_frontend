              ...
              <tbody>
                {orders.map((order: any, index: number) => (
                  <tr key={index}>
                    {order.status === "pending" || order.status === "delayed" ?
                      <>
                        ...
                        <td className='py-2 text-center px-2 capitalize font-bold'>{order.generatedBy.username}</td>
                        <td className='py-2 text-center px-2 font-semibold text-gray-600'>
                  ...
                  `}>
                        ...
                        <td className='text-center font-semibold text-gray-600'>{order.estimatedDispatchDate.split('T')[0]}</td>
              ...
              (order.status === "pending" || order.status === "delayed") && (
                <div key={index} className='bg-white dark:bg-zinc-800 shadow-md rounded-lg p-4 flex flex-col gap-2'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='text-end font-semibold text-gray-600'>{order.orderdate ? formatDate(order.orderDate) : formatDate(order.createdAt)}</span>
                  </div>
                  <div className='flex justify-between'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='text-end font-semibold text-gray-600'>{order.estimatedDispatchDate.split('T')[0]}</span>
                  </div>
