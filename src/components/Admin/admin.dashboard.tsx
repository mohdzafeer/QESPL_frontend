    ...
    <>
      <div className="flex flex-col h-screen scrollbar-hide">
        <div className="flex flex-1">
          <div className="flex-1 bg-gray-100 dark:bg-zinc-700">
            <div className="dash p-2 sm:p-4 md:p-6 m-1 sm:m-2 md:m-4 rounded  dark:text-white h-fit max-w-screen relative overflow-auto scrollbar-hide">
              {showAlert && (
                  ...
                  <div className="flex justify-between lg:flex-row flex-col gap-2">
                    ...
                    >
                          ...
                          <button
                            className={`py-2 px-3 rounded-lg text-sm font-semibold ${
                              timeFilter === "weekly"
                                ...
                                : "bg-gray-200 text-[#0A2975] hover:bg-gray-300"
                            }`}
                      ...
                      <POChart
                        ...
                        query={debouncedSearchQuery}
                      />
                      {/* <POChart className="w-full h-64" type="bar" /> */}
                    </motion.div>

                    <motion.div
                      initial={{ y: 0 }}
                      whileHover={{ y: -5, transition: { duration: 0.3 } }}
                      className="xl:w-1/2 lg:w-1/2 w-full border-2 border-gray-300 rounded-lg p-5 "
                    >
              ...
              <div className="border-2 border-gray-300 rounded-lg p-5 mt-10 mb-5 overflow-x-auto lg:text-lg md:text-sm text-xs">
                <div className="flex justify-between lg:flex-row xl:flex-row flex-col  text-sm items-start mb-4">
                  ...
                  <div className="flex items-end gap-4 xl:flex-row lg:flex-row flex-col xl:text-sm lg:text-sm text-xs mt-2">
                    <span className="search border-2 bg-white  dark:bg-zinc-600 w-full  flex items-center justify-center rounded-lg">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                    ...
                    <div className="flex flex-row md:flex-row gap-4 w-full">
                      <div className="flex flex-col w-full md:w-1/2">
                        ...
                        <input
                          ...
                          className={`p-2 border bg-white dark:bg-zinc-600 ${
                            errors.fromDate
                              ? "border-red-500"
                              : "border-gray-300"
                ...
                <div className="w-full">
                  ...
                  <div className="flex justify-center items-center gap-2 mt-4">
                    <button
                      ...
                      className="px-2 py-1 rounded bg-gray-200 dark:bg-zinc-950 text-xs hover:bg-blue-200 disabled:opacity-50"
                    >
                      ←
                    </button>
                      ...
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm ${
                          currentPage === i + 1
                            ...
                            : "bg-gray-100 dark:bg-zinc-500 text-black hover:bg-blue-100"
                        }`}
                      >
                        {i + 1}
                      </button>
