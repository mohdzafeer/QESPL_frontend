  ...
  return (
    <div className="lg:w-4xl xl:w-4xl w-sm  lg:max-h-[600px] xl:max-h-[600px] max-h-[700px] overflow-y-auto overflow-x-hidden no-scrollbar rounded-xl bg-white py-5 px-10 flex flex-col dark:text-white dark:bg-zinc-900">
      ...
      <div className="flex justify-center items-center">
        <button onClick={()=>handleDownload(order)} className="px-3 py-2 bg-blue-500 mt-5 rounded-lg text-white text-sm max-w-fit flex items-center gap-4 font-semibold cursor-pointer hover:bg-blue-300 duration-300 active:bg-blue-600">
          Print <MdPrint />
        </button>
      </div>
    </div>
