  ...
  return (
    <div className="lg:w-4xl xl:w-4xl w-sm  lg:max-h-[600px] xl:max-h-[600px] max-h-[700px] overflow-y-auto overflow-x-hidden no-scrollbar rounded-xl bg-white py-5 px-10 flex flex-col dark:text-white dark:bg-zinc-900">
      ...
      <div className="flex justify-between mt-1 gap-4 flex-col lg:flex-row xl:flex-row">
        {/* Generated By */}
        <div className="flex flex-col text-sm text-start bg-gray-100 dark:bg-zinc-900 px-2 py-4 lg:pr-60 xl:pr-60">
        ...
        {/* Order Through */}
        <div className="flex flex-col text-sm text-start bg-gray-100 dark:bg-zinc-900 px-2 py-4">
          ...
          <span>
            Employee Name :{" "}
            <span className="font-semibold">
              {order.formGeneratedBy || order.generatedBy?.name || "N/A"}
            </span>
          </span>
          <span>
            Employee Id :{" "}
