...
//       setSelected([]);
//       setSelectAll(false);
//       toast.error("PO Deleting Permanetly.....");
...
//           <div className="fixed mx-auto top-8 left-0 right-0 w-sm max-h-fit bg-red-100 text-red-500 flex flex-col gap-4 p-4 rounded-lg border border-red-200 shadow-lg z-50">
//             <span className="text-lg font-semibold">
//               Are you sure You want to delete PO(s)
//             </span>
//             <div className="flex gap-4 justify-end mt-4">
//               <button
//                 onClick={deleteSelected}
//                 className="bg-red-500 text-white px-3 py-2 rounded-lg font-semibold hover:bg-red-600 duration-300 cursor-pointer"
//               >
//                 Yes, Delete
//               </button>
//               <button
//                 onClick={() => setConfirmDelete(false)}
//                 className="bg-red-200 text-red-500 px-3 py-2 rounded-lg font-semibold border hover:bg-red-100 hover:border hover:border-red-400 cursor-pointer duration-300"
//               >
//                 No, Cancel
//               </button>
//             </div>
              ...
              orders.map((data: Order) => (
                ...
                >
                  ...
                  <td className="p-2 flex items-center gap-3">
                    <img
                      src={
                        data?.generatedBy?.username ?  'https://cdn.pixabay.com/photo/2023/02/18/11/00/icon-7797704_640.png' : ''
                      }
                  ...
                  <td className="p-2">{data?.clientName}</td>{" "}
                  {/* Use clientName */}
                  <td className="p-2">{formatDate(data?.createdAt) ? formatDate(data?.createdAt):''}</td>{" "}
                  {/* Use createdAt */}
                  <td
                    className={`p-2 font-semibold ${
                      data?.status === "completed"
