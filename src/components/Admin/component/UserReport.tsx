...
const UserReport: React.FC<UserReportProps> = ({
  ...
  <div className="lg:w-lg xl:w-lg w-sm bg-white rounded-xl shadow-lg p-8 flex flex-col items-center space-y-6 relative border">
    {onClose && (
      <button
    ...
    <div className="w-full mt-6">
      ...
      <div className="flex flex-col items-start gap-2">
        <span className="text-start w-full">Permissions : </span>
        <div className="flex gap-3">
          <div className="flex items-center gap-1">
            <input id="readOnly" type="checkbox" />
            <label htmlFor="readOnly">Read</label>
          </div>
          <div className="flex items-center gap-1">
        ...
        <button className="bg-blue-500 px-2 py-1 text-sm text-white font-semibold rounded hover:bg-blue-600 cursor-pointer duration-300 active:bg-blue-500">Update Permissions</button>
      </div>
    </div>
  </div>
);
