...
const LoginForm = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row items-center justify-center lg:py-10 lg:px-56 px-10 pt-16">
      <div className="wrapper flex flex-col md:flex-row items-center justify-center bg-gray-100 w-full xl:h-[600px] lg:h-[600px] md:h-[800px] overflow-hidden rounded-2xl custom-shadow">
        <div className="sider lg:inline-flex md:inline-flex flex-col items-center justify-center lg:min-h-[50vh]  hidden bg-gray-100 w-full md:w-1/2 py-6 px-4">
          ...
          >
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-3 border-2 border-gray-300 rounded-xl text-base focus:outline-none text-black "
                {...register("email")}
              />
              {errors.email && (
            ...
            <div className="mb-4">
              <div className="flex border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-black">
                <input
                  ...
                  className="w-full p-3  text-base focus:outline-none text-black"
                  {...register("password")}
                />
                <button
                  type="button"
